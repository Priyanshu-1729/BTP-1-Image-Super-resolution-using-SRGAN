...
# custom_vgg19 = load_model('custom_vgg19.h5')

from tensorflow.keras.models import load_model
custom_vgg19 = load_model('custom_vgg19.keras')

class vgg19(nn.Module):
    
    def __init__(self, custom_model, require_grad=False):
        custom_model = vgg19(custom_vgg19)
        super(vgg19, self).__init__()
        self.vgg_feature = custom_model.features
